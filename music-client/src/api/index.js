...
// 返回歌单里指定歌单ID的歌曲
export const getListSongOfSongId = (songListId, userId) => get(`listSong/detail?songListId=${songListId}&userId=${userId}`)
...
// 播放音乐, 进行统计
export const setCount = (params) => post("song/count", params)
