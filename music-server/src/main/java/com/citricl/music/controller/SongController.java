...
import com.citricl.music.config.Constant;
...
public class SongController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songPic/**").addResourceLocations(Constant.SONG_PIC_PATH);
            registry.addResourceHandler("/song/**").addResourceLocations(Constant.SONG_SRC_PATH);
        }
    }
...
//    添加歌曲
    ...
    public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "music-server/song";
...
//    返回指定歌曲ID的歌曲
    ...
    @RequestMapping(value = "/song/count", method = RequestMethod.POST)
    public void count(HttpServletRequest req){
        String userId = req.getParameter("userId").trim();
        String songId = req.getParameter("songId").trim();

        songService.count(Integer.parseInt(userId), Integer.parseInt(songId));
    }
...
//    更新歌曲图片
    ...
    public Object updateSongPic(@RequestParam("file") MultipartFile urlFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "music-server/img" + System.getProperty("file.separator") + "music-server/songPic";
        File file1 = new File(filePath);
        if (!file1.exists()){
            file1.mkdir();
        }
