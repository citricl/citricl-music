...
import com.citricl.music.domain.Singer;
import com.citricl.music.service.impl.SingerServiceImpl;
...
public class SingerController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/singerPic/**").addResourceLocations(Constant.SINGER_PIC_PATH);
        }
    }
...
//    更新歌手头像
    ...
    public Object updateSingerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = System.getProperty("user.dir") + System.getProperty("file.separator") + "music-server/img/singerPic" ;
